...
// Inline Remix Icon path (ri/qq-fill). Apache-2.0 licensed path.
export function QqIcon({ className = "size-3", ...props }: SocialIconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function TriangleIcon({
  ...
  className,
  ...props
}: { direction: TriangleDirection } & SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 16 16"
      aria-hidden="true"
      ...
      className={className}
      {...props}>
      <path d={trianglePathByDirection[direction]} fill="currentColor" />
    </svg>
  )
}

// Inline Lucide icon paths (Sun / Moon / Monitor / Check).
